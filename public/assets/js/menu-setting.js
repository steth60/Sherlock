...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector('body').insertAdjacentHTML("beforeend", '' +
        ...
        '<a href="../navigation/index-2.html" class="" data-value="l2" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-2-2.html" class="" data-value="l2-2" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-3.html" class="" data-value="l3" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-4.html" class="" data-value="l4" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-4-2.html" class="" data-value="l4-2" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-5-h.html" class="" data-value="l5-h" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-light.html" class="" data-value="l-lite" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-6.html" class="" data-value="l6" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-8.html" class="" data-value="l8" target="_blank"><span></span><span></span></a>' +
        '<a href="../navigation/index-1.html" class="" data-value="l1" target="_blank"><span></span><span></span></a>' +
        '</div>' +
    ...
    for (var h = 0; h < layouttypes.length; h++) {
        ...
        c.addEventListener('click', function (event) {
            ...
            if (temp == "dark") {
                removeClassByPrefix(document.querySelector(".pcoded-navbar"), 'menu-');
                document.querySelector(".pcoded-navbar").classList.add("navbar-dark");
                document.querySelector(".layout-css").setAttribute('href', '../assets/css/layouts/dark.css');
            } else {
