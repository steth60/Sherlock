...
@section('content')
                ...
                <div class="card-header">{{ __('Email Multi-Factor Authentication Challenge') }}</div>

                <div class="card-body">
                    <form id="sendMfaForm" action="{{ route('two-factor.challenge.email.send') }}" method="POST">
                        @csrf
                    ...
                    <p id="retryMessage" class="text-muted"></p>
